...
// specific course, e.g.
//   https://portal.lefclimbing.com/lef/programs/top-rope-class?course=…&date=2026-05-18
...
function urlFor(row, plansById) {
  ...
  const path = slug ? `/lef/programs/${slug}` : '/lef';
  return `https://portal.lefclimbing.com${path}?${params.toString()}`;
}
