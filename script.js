// LEF Climbing — site script. Minimal, accessible.
(function () {
  'use strict';
  ...
  function buildChatWidget() {
    ...
    panel.setAttribute('aria-label', 'Contact LEF Climbing');
    panel.dataset.open = 'false';
    panel.innerHTML = `
      <header>
        <div class="avatar" aria-hidden="true">L</div>
        <div class="who">
          <strong>LEF Climbing</strong>
      ...
      <form class="chat-form" data-chat-form novalidate>
        ...
        <div class="submit-row">
          <span class="alt">or call <a href="tel:+18595230518">859&middot;523&middot;0518</a></span>
          <button type="submit" class="btn btn-primary">Send</button>
        </div>
      </form>
      <p class="alt mt-3" data-chat-success hidden>Thanks — we'll get back to you within a day. For anything urgent, email <a href="mailto:${FALLBACK_EMAIL}">${FALLBACK_EMAIL}</a> or call <a href="tel:+18595230518">859&middot;523&middot;0518</a>.</p>
